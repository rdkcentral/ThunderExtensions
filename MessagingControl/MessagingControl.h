...
namespace Plugin {
    ...
    public:
        ...
        {
            std::list<Exchange::IMessagingControl::Control> list;
            ...
            using Implementation = RPC::IteratorType<Exchange::IMessagingControl::IControlIterator>;
            controls = Core::Service<Implementation>::Create<Exchange::IMessagingControl::IControlIterator>(list);

            return (Core::ERROR_NONE);
        }

        Core::hresult Controls(Exchange::IMessagingControl::IControlIterator*& controls) const override
        {
